    ...
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
           ...
           // rtfReceipt.AppendText(Environment.NewLine);
            rtfReceipt.AppendText("-------------------------------------------------------------" + Environment.NewLine);
            rtfReceipt.AppendText("\t\t" + "Cafe de NMIT" + Environment.NewLine);
            rtfReceipt.AppendText("-------------------------------------------------------------" + Environment.NewLine);
        ...
        { //btnTotal
            ...
            lat = 120.0; mocha = 129.0; espr = 129.0; vale = 145.0; cappu = 170.0; afri = 150.0; mTea = 145.0; cTea = 110.0; //coffee pries
            cCake = 130.0; rValvet = 120.0; bFor = 130.0; bCream = 190.0; lChoco = 150.0; kChoco = 140.0; cheese = 130.0; rain = 110.0; //cake prices
